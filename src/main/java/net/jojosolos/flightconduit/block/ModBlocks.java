...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> FLIGHT_CONDUIT_BLOCK = registerBlock("flight_conduit_block",
            () -> new FlightConduitBlock(BlockBehaviour.Properties.copy(Blocks.CONDUIT).noOcclusion()));
